...
class _GameCardState extends State<GameCard> {
  ...
  String generateGenreString(){
    Map<String, dynamic> genreData = Map<String, dynamic>.from(this.widget.game.genres);
    var genres = "";

    for(int x=0; x<genreData.keys.length; x++){
      if(x==0) genres += genreData.keys.elementAt(x);
      else genres += ', ' + genreData.keys.elementAt(x);
    }
